...
public class DemandeListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demande_list);
        ...
        adapter = new DemandeAdapter(this, demandeList);
    ...
    private void fetchDataFromApi() {
        ...
        String url = "http://10.0.2.2:9090/reclamation";
